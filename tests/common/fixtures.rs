...
use exchange::{Trade, Kline, Price, MinTicksize, TickerInfo, Exchange, Ticker};
use std::path::Path;
use std::io::Write;
...
pub fn generate_test_trades(
    ...
    for i in 0..count {
        ...
        let trade = Trade {
            ...
            is_sell: (i * 13) % 2 == 0,
            price: Price::from_f32(current_price).round_to_min_tick(MinTicksize::ZeroPointZeroOne),
